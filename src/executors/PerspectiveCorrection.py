...
class PerspectiveCorrection(Component):
    ...
    def _strategy_classic_contours(self, image_gray: np.ndarray) -> List[np.ndarray]:
        ...
        blurred = cv2.GaussianBlur(image_gray, (5, 5), 0)  # Hafif bulanıklaştırma Canny'e yardımcı olur
    ...
    def run(self):
        ...
        work_img_gray = cv2.cvtColor(work_img, cv2.COLOR_BGR_GRAY)
        ...
        candidates.extend(self._strategy_adaptive_thresh(work_img_gray))  # YENİ UZMANI ÇAĞIR
